        ...
        Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) => DonutsDetailsPage(
                item: DonutsItem(imagePath: widget.offerItem.imagePath, donutName: widget.offerItem.donutName, donutDescription: widget.offerItem.donutDescription, donutPrice: widget.offerItem.offer),
              )),
        );
      },
